...
/* package gui-0.1.0.0 */
#ifndef VERSION_gui
#define VERSION_gui "0.1.0.0"
#endif /* VERSION_gui */
#ifndef MIN_VERSION_gui
#define MIN_VERSION_gui(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gui */
...
#define CURRENT_COMPONENT_ID "gui-0.1.0.0-9QePWBljgOvIWb7VneCBlf-gui"
